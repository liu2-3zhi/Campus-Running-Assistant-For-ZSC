    ...
    >
      ...
      <template #path>
        <div class="grid grid-cols-2 gap-2 pt-3">
          ...
          <button v-if="!app.isMobile" class="btn btn-secondary justify-center" @click="processPath">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button class="btn btn-secondary justify-center" :class="{ 'col-span-2': app.isMobile }" @click="exportPath">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
